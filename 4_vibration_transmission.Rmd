...
ggplot() +
  geom_line(aes(x = Low_Freq, y = mean_snr, color = Site_Treatment, linetype = Site_Treatment), alpha = 0.15, data = close_ind) +
  ...
  #ylab("Energy Loss (∆ dB)\n\n") +
  ylab("Energy Loss through \nWeb Transmission (∆ dB)") +
  scale_fill_manual("Site_Treatment", values = c("#1b9e77", "#1b9e77", "#d95f02", "#d95f02")) +
  scale_color_manual("Site_Treatment", values = c("#1b9e77", "#1b9e77", "#d95f02", "#d95f02")) +

...
anova(gam_attack_null, gam_attack4, test = "F") # model with frequency by site is better than the null model
...
ggplot() +
 ...
 # geom_line(aes(x = order, y = prop, color = Site), alpha = 0.5, data = fr_attack_sum) +
  ...
  scale_x_continuous(limits = c(0, 10), breaks = c(seq(0,10,1)), expand = c(0,0)) +
